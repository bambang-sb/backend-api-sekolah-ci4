        ...
        <div class="card">
          <div class="card-header">
            <div class="d-flex align-items-center">
              <h4 class="card-title">Data Kelas Active</h4>
              <button
                id="btn-tambah"
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="d-flex align-items-center mb-2">
                            ...
                            <input type="hidden" name='id' id="id-kelas-aktif">
                            <label class="col-md-2 col-form-label">Th Ajaran</label>
                            <select name="thajaran" id="thajaran" class="form-control">
                              <option value="<?= $thajaran->id_th_ajaran ?>"><?= $thajaran->th_ajaran.' - '.($thajaran->semester == 0?'Genap':'Ganjil') ?></option>
                            </select>
                          </div>
                          <div class="d-flex align-items-center mb-2">
                            ...
                            <select name="kelas" id="kelas" class="form-control">
                              ...
                              <?php foreach($kelas as $k): ?>
                                <option value="<?= $k->id_kelas ?>"><?= $k->level.' '.$k->nama_kelas ?></option>
                              <?php endforeach; ?>
                            </select>
                          </div>
                          <div class="d-flex align-items-center mb-2">
...
<?= $this->section('script') ?>
<script src="<?= base_url('pages-js/kelas-aktif.js') ?>"></script>
<?= $this->endSection() ?>
